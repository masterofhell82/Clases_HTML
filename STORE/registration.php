    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">CatalogoMultinacional</small></h1>
            </div>
                          ...
                          <div class="container-fluid">
                            <div class="row">
                              <div class="col-xs-12">
							   ...
							   <!-- Para empezar a capturar los datos del usuario y poder registrarlo -->
                              <div class="col-xs-12">
	 ...
	 <!-- Para incluir el archivo footer y asi poder mostrar la informacion de la empresa -->
