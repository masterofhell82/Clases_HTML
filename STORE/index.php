...
<body id="container-page-index">
    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
			...
			<div class="item">
                <img src="./assets/img/slider4.jpg" alt="slider4">
                <div class="carousel-caption">
                    Arte Moderno
                </div>
            </div>
        ...
        <!-- botones prev y next para el carruzel-->
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">CatalogoMultinacional</span> en un sencillo formulario para poder completar tus pedidos</p>
