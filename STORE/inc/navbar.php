...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <p class="text-navbar tittles-pages-logo">CatalogoMultinacional</p>
            </div>
            <div class="col-xs-8">
	...
	<!-- Formulario Iniciador de sesion-->
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">CatalogoMultinacional</h3>
