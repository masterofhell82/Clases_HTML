...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="configAdmin.php?view=productlist"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Productos en el Catalogo</a>
    </li>
</ul>

 <!-- Para crear el cuadro que mostrara la informacion de todo los productos ya registrados -->
<div class="container">
	<div class="row">
		<div class="col-xs-12">
            <br><br>
            <div class="panel panel-info">
              <div class="panel-heading text-center"><h4>Productos en el Catalogo</h4></div>
                <div class="table-responsive">
                  <table class="table table-striped table-hover">
                      <thead class="">
					   ...
					   <!-- Para Buscar los Datos en la BD -->
                      <tbody>
                        <?php
