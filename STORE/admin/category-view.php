...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="configAdmin.php?view=categorylist"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Categoría del Catalogo</a>
    </li>
</ul>
 <!-- Creando formulario para capturar los datos de la nueva categoria-->
<div class="container">
	<div class="row">
        <div class="col-xs-12">
