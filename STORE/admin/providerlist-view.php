...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="configAdmin.php?view=providerlist"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Proveedores </a>
    </li>
</ul>
<div class="container">
	<div class="row">
		<div class="col-xs-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading text-center"><h4>Proveedores registrados</h4></div>
                  ...
                  <table class="table table-striped table-hover">
                      	...
                      	<tbody>
                            ...
                            ?>
							 <!-- Para sacar los datos de los provedores ya registrados de la BD-->
							<tr>
